...
urlpatterns = [
    ...
    # Purchase Orders - FIXED: Use uuid pattern for all PO URLs
    ...
    path('purchase-orders/<uuid:po_id>/print/', views.purchase_order_print_view, name='purchase_order_print'),  # FIXED: Changed to uuid
